...
import com.wmhas.serviceImpl.MedicalServiceImpl;
...
public class MedicalController {
    ...
    ResponseEntity<Map<String, Object>> getMedicineInfo() {
        return ResponseEntity.ok(medicalService.getMedicineInfo());
    }
}
